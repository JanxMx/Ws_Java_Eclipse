...
public class FindWords {
	...
	public static void main(String[] args) {
		...
		DiscoverWords x = new DiscoverWords(letters, types);
	}
}

class DiscoverWords {

	public DiscoverWords(List<String> letters, int[] types) {
	...
	private void createWords(List<String> letters, int len, String base) {
		...
		for(String x: letters) {
			...
			//System.out.println("len:" + len + " -" + (base!=null?base:"") + x);
			System.out.println("len:" + len + " -" + base + x);
			/*
			if(len>1) {
			...
			System.out.println("otro...");
			List<String> lettersTemp = new ArrayList<>();
			lettersTemp.addAll(letters);
			lettersTemp.remove(0);
			System.out.println("lettersTemp -->" + lettersTemp);
			System.out.println("lettersOriginal -->" + letters);
			int lenTemp = len - 1;
			//createWords(lettersTemp , lenTemp, base + letters.get(x));
			createWords(lettersTemp , lenTemp, base + x);
