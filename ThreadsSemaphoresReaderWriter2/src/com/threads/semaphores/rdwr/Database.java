...
/*
 * This class represent a database. There are many competing threads wishing to read and write.
 * It is acceptable to have multiple processes reading at the same time, but if one thread is
 * writing then no other process may either read or write
 */
